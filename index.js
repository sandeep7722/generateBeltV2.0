...
const input={
    prompt: "Generate an exquisite 8K digital image showcasing a complete view of a Ralph Lauren belt adorned with enchanting butterfly and floral designs. Ensure the entire belt is prominently featured in the composition, leaving no part of it cropped. Exclude any human body from the frame. Create a visually stunning scene that accentuates the luxury and beauty of the belt, keeping the observer's focus solely on this stylish accessory."
  };
